...
srot = library_function(
    ...
    [len_t, float_t_ptr, inc_t, float_t_ptr, inc_t, float_t, float_t],
    """Applies a plane rotation (single-precision).
    """)

sswap = library_function(
    libsp, 'sp_blas_sswap', None,
    [len_t, float_t_ptr, inc_t, float_t_ptr, inc_t],
...
srotm = library_function(
    ...
    [len_t, float_t_ptr, inc_t, float_t_ptr, inc_t, float_t_ptr],
